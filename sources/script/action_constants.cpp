...
namespace as1
{
    ...
    const char* actionCodeName(std::uint32_t opcode)
    {
        ...
        case 59: return "ACT_GET_ITEM_TYPE";
        ...
        case 74: return "ACT_RESTORE_COMMAND";
        case 75: return "ACT_COPY_STACK_TO";
        case 76: return "ACT_NO_STACK";
        ...
        case 91: return "ACT_SET_GOAL_COOR";
